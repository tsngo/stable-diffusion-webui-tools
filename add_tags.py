    ...
    for file in files:
        ...
        try:
            ...
            ps = propsys.SHGetPropertyStoreFromParsingName(
                os.path.realpath(file), None, shellcon.GPS_READWRITE, propsys.IID_IPropertyStore)
            ...
            print(f"Unable to tag file {file}. Tags may not be supported for this file type.")
